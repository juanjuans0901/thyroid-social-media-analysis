...
topics=['T1: Postoperative Recovery','T2: Cancer Progression','T3: Diagnostic Evaluation',
        'T4: Treatment Decision','T5: Healthcare Navigation']
...
ax=fig.add_axes([0.235,0.300,0.640,0.560])
...
for r,(t,c) in enumerate(zip(topics,tcol)):
    ax.text(-0.60,r,t,ha='right',va='center',fontsize=14,color=c)
